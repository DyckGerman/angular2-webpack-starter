...
> !!!
> This repo is a private fork with some extra confusing features (such as HMR) EXCLUDED. Application related code is stripped too.
> !!!

* [EXCLUDED] Best practices in file and application organization for Angular 2.
* [EXCLUDED] Angular 2 examples that are ready to go when experimenting with Angular 2.
* [EXCLUDED for now] Ahead of Time (AoT) compile for rapid page loads of your production builds.
* [EXCLUDED] Hot Module Replacement with Webpack and [@angularclass/hmr](https://github.com/angularclass/angular2-hmr) and [@angularclass/hmr-loader](https://github.com/angularclass/angular2-hmr-loader)
* [EXCLUDED] Material Design with [angular/material2](https://github.com/angular/material2)
* [EXCLUDED for now] [Webpack DLLs](https://robertknight.github.io/posts/webpack-dll-plugins/) dramatically speed your development builds.
...
# Table of some usefull Contents not necessary related to this repos state of art
